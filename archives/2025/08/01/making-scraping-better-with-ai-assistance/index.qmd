...
knitr::include_graphics("testudo_soc.png")
```
...
```{r, echo=FALSE, out.width="600px"}
knitr::include_graphics("copilot_repo.png")
```
...
```{r, echo=FALSE, out.width="600px"}
knitr::include_graphics("course_syllabi.png")
```
